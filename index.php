...
$type = $_POST['type'];
		...
		$row=0;
		$sql=("select * from admininfo where username='$username' and password='$password' and type='$type'");
	...
	<div class="row">
		...
		<form method="post" class="form-horizontal col-md-6 col-md-offset-3">
			...
			<div class="col-sm-6">
			  	  ...
			  	  <label>
			    <input type="radio" name="type" id="optionsRadios1" value="teacher"> Employee
			  </label>
			  <label>
